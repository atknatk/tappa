...
**Ne kaldı:** ⏳ D-A (depo private? scrub push) · D-B (süper admin (c)) · D-C (tap ekranı markası, §9) · D-D (akış sırası). Sonra M10 Faz 0 → A1.
