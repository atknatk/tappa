...
**Son güncelleme:** 2026-08-14 (10. oturum — **M7-03 FAZ A DONE · migration 00018 · ADR 0014 · sıradaki M7-03 FAZ B**)
...
| M7-03 | Tenant provisioning | **wip** — **FAZ A done** (`81ce4d5`, migration **00018**, ADR **0014**, 5 tur / 2 RED, iki denetçi + `tappa-security-auditor`). Kartın dört kriterinden **üçü M7-02'de sevk edilmişti**; A, M7-02'nin devrettiği **(b) limitini** kapattı: `admin_users.password_hash` artık **şema düzeyinde** işlenebilir bir bcrypt digest'i olmak zorunda. ⚠️ **FAZ B AÇIK** — departmanlar · "tag bekleniyor" durumu | |
...
**Özet:** 83 görev · done **65** · **wip 1** (M7-03, Faz A done) · blocked 0 · skipped 1 · todo **16** · **M0+M1+M2+M3+M4+M5+M6 TAMAM 🎉🎉 · M7 2/5** — **ürünün fonksiyonel boşluğu kapandı: artık herkes kayıt olabiliyor** *(M5-11 M5-09'da bulunan §5 ihlali için kullanıcı kararıyla açıldı → toplam 82'den 83'e)*
...
**Ne kaldı.** **M7-03 FAZ B** — departmanlar (ön karar: sihirbaza adım **ekleme**, yapıcı yanlışlamaya çalışsın) ve **ilk inilen ekranda** "plaketin yolda" durumu. Backlog **T31–T34** eklendi; **T31 kullanıcının işi** (`go1.26.5 → 1.26.6`, `make audit` bugün exit 3).
