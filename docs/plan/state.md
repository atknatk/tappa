...
**Son güncelleme:** 2026-08-18 (13. oturum — **M8-02 FAZ F DONE** (`a32d0ca`, 17 tur/9 RED) · **DEPLOY ILK KEZ UCTAN UCA YESIL** (`32032319245`, RBAC uygulandi) · **M6-13 DONE** (`5431bad`, 9 denetim turu/6 RED — canli uretimde bulundu: **urun calisan YARATAMIYORDU**) · Docker Hub kuruldu · siradaki **M8-03**)
