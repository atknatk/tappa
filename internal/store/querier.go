...
type Querier interface {
	...
	GetAdminPasswordHashByID(ctx context.Context, arg GetAdminPasswordHashByIDParams) (GetAdminPasswordHashByIDRow, error)
	...
	ListPublishedLegalDocuments(ctx context.Context) ([]ListPublishedLegalDocumentsRow, error)
	...
	MarkTagEncoded(ctx context.Context, arg MarkTagEncodedParams) (MarkTagEncodedRow, error)
	...
	RevokeOtherAdminSessionsForAdmin(ctx context.Context, arg RevokeOtherAdminSessionsForAdminParams) ([]uuid.UUID, error)
	...
	SetOwnAdminPassword(ctx context.Context, arg SetOwnAdminPasswordParams) (uuid.UUID, error)
