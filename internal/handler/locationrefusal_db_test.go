...
func newRefusalFixture(t *testing.T, role string) *refusalFixture {
	...
	h, err := NewAdminAuth(admins, trail, records, records, &fakeReviewer{},
		&fakeStaff{}, &fakeInviter{}, f.venues, f.plaques, &fakeRecorder{}, newFakeRules(), newFakeScribe(), newFakeBooks(), newFakeTexts(), newFakeAccount(), nil, adminTestConfig(), discardLogger())
	if err != nil {
