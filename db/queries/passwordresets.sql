...
WITH retired AS (
    ...
    WHERE p.tenant_id = @tenant_id
      AND p.admin_user_id = @admin_user_id
...
SELECT a.tenant_id, a.id, @token_hash, @expires_at
FROM admin_users a
WHERE a.id = @admin_user_id
  AND a.tenant_id = @tenant_id
  AND a.status = 'active'
...
-- name: ConsumePasswordResetAndSetPassword :one
...
-- name: ListLivePasswordResetsForAdmin :many
