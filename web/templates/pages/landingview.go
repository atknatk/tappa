...
var LandingPricingIncludes = []Line{
	...
	{
		Text: "Manual entries for a day the phone stayed at home — recorded against the " +
			"manager who entered them, and marked as typed rather than tapped.",
...
var LandingFAQ = []Question{
	...
	},
	{
		...
		A: "A manager types the entry from the dashboard. It is recorded against that " +
			"manager and marked as entered by hand rather than tapped, so a record that " +
	...
	},
	{
		...
		A: "No. A recorded tap is never changed and never deleted. A correction is a new " +
			"record with the manager who entered it recorded on it, and both stay — that is " +
			"what makes the record usable as evidence later.",
